(function() {
  ...
  style.textContent = [
    ...
    "#blun-support-bubble{position:fixed;bottom:24px;right:24px;width:56px;height:56px;border-radius:50%;background:#f59e0b;cursor:pointer;z-index:10000;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 20px rgba(245,158,11,0.4);transition:transform 0.2s ease,box-shadow 0.2s ease;}",
    "#blun-support-bubble:hover{transform:scale(1.08);box-shadow:0 6px 28px rgba(245,158,11,0.5);}",
    ...
    ".blun-msg.user{align-self:flex-end;background:#f59e0b;color:#0a0a0a;border-bottom-right-radius:4px;font-weight:500;}",
    ...
    "#blun-support-input:focus{border-color:#f59e0b;}",
    "#blun-support-input::placeholder{color:#52525b;}",
    "#blun-support-send{background:#f59e0b;border:none;border-radius:8px;width:36px;height:36px;cursor:pointer;display:flex;align-items:center;justify-content:center;transition:background 0.15s;}",
    "#blun-support-send:hover{background:#d97706;}",
